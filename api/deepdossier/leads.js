...
const SEED = [
  ...
  // Batch 2, enriched via the Apollo connector (verified emails; mobile needs a phone-data source).
  { name: 'Marion Jones', title: 'Owner and Director', company: 'Spotlite Claims', email: 'marionj@spotliteclaims.com', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/marion-jones-a628ab16', location: 'Bricket Wood, United Kingdom', confidence: 79, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Greig Birrell', title: 'Client Director', company: 'Kubiq Adjusters', email: 'gbirrell@kudosadjusters.com', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/greig-birrell-062004166', location: 'Leeds, United Kingdom', confidence: 74, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Neale Walford', title: 'Technical Director', company: 'Kubiq Adjusters', email: 'nwalford@kudosadjusters.com', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/neale-walford-a48518a3', location: 'United Kingdom', confidence: 73, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Victor Benjamin', title: 'Director', company: 'WPI', email: 'vbenjamin@williams-pitt.com', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/victor-benjamin-b834763b1', location: 'Southend-on-Sea, United Kingdom', confidence: 75, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Graham Kelly', title: 'Director', company: 'Kelly Adjusters Limited', email: 'grahamkelly@kellyadjusters.co.uk', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/graham-kelly-5bab8525', location: 'Felsted, United Kingdom', confidence: 76, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Doreen Johnson', title: 'Director', company: 'Kelly Adjusters Limited', email: 'doreenjohnson@kellyadjusters.co.uk', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/doreen-johnson-b6b0b65a', location: 'Billingshurst, United Kingdom', confidence: 74, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Neil Baldwin', title: 'Executive Director', company: 'McLarens', email: 'neil.baldwin@mclarens.com', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/neil-baldwin-74b67b4b', location: 'Bromley, United Kingdom', confidence: 76, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Steven Wallace', title: 'Managing Director - EMEA', company: 'McLarens', email: 'steven.wallace@mclarens.com', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/steven-wallace-16122444', location: 'United Kingdom', confidence: 77, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Paul Bullett', title: 'Major Loss Client Director', company: 'Woodgate and Clark Limited', email: 'p.bullett@woodgate-clark.co.uk', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/paul-bullett-3016a119', location: 'Studley, United Kingdom', confidence: 75, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
  { name: 'Frank Benke', title: 'Director', company: 'McLarens', email: 'frank.benke@mclarens.com', mobile: '', emailVerified: 'Yes', linkedin: 'https://www.linkedin.com/in/frank-benke-88b865163', location: 'London, United Kingdom', confidence: 74, match: { band: 'amber', label: 'Partial match' }, companiesHouse: { found: false }, news: [], sources: 'Apollo' },
];
