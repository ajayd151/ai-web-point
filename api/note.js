...
const STATUSES = ['contacted', 'no-answer', 'interested', 'site-reply', 'appointment-link-sent', 'meeting-booked', 'callback', 'not-interested', 'has-website', 'declined', 'invalid-phone', 'won', 'lost', 'dnd'];
