...
module.exports = async (req, res) => {
  ...
  try {
    ...
    await put(`${base}.json`, JSON.stringify({ name: business.name || '', loc: business.location || '', who, cta, img: png.url, phone, category: business.category || '', mapsUrl: business.mapsUrl || '', placeId: business.id || '' }), { access: 'public', contentType: 'application/json', addRandomSuffix: false });
