...
function voRenderCampaigns() {
  ...
  const rows = VO.campaigns.map((c) => '<tr data-id="' + c.id + '">' +
    ...
    '<td class="num">' + (c.prospects_found || 0) + '</td><td class="num">' + (c.requested || 0) + '</td><td class="num">' + (c.connected || 0) + '</td><td class="num">' + (c.videos_sent || 0) + ((c.connected || 0) > (c.videos_sent || 0) ? '<div class="vo-small vo-no">' + ((c.connected || 0) - (c.videos_sent || 0)) + ' waiting for a video</div>' : '') + '</td><td class="num"><span class="vo-reply sp">' + (c.positive_replies || 0) + '</span></td><td class="num">' + Math.max(0, (c.replied || 0) - (c.positive_replies || 0)) + '</td>' +
