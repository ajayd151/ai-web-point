...
async function reportData(account) {
  ...
  return { day, waiting, replied_open, events, skipped: await skippedLinkedin(account), followups_due: followups.length, campaigns: await listCampaigns(account), linkedin: li, today_requests: await countLinkedinSince(account, ['Request sent'], sod.toISOString()), week_requests: await countLinkedinSince(account, ['Request sent'], sow.toISOString()) };
}
