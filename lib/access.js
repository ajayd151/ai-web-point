...
const PERM_KEYS = ['search', 'seeLeads', 'deleteLeads', 'export', 'mockups', 'sites', 'prowl', 'sms', 'emails', 'callList', 'block'];
// Numeric caps a team member can be given (null/absent = unlimited).
const LIMIT_KEYS = ['searchMax', 'callListMax'];
...
module.exports = { account, requirePaid, isComped, sessionEmail, canDeepDossier, requireDeepDossier, can, requirePermission, PERM_KEYS, LIMIT_KEYS, cleanLimits };
