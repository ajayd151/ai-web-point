...
async function sendTeamInviteEmail({ to, firstName, ownerEmail }) {
  ...
  const text = hi + '\n\n' +
    ...
    'Set up your account:\n' +
    '1. Go to ' + base + '\n' +
    '2. Choose "Get started" and sign up with THIS email address: ' + to + '\n' +
    '3. Create your own password (only you will know it).\n\n' +
    'Already have an account? Just sign in. Forgot your password? Use the "Forgot password?" link on the sign-in box to reset it.\n\n' +
  ...
  const html = '<div style="font-family:-apple-system,Segoe UI,Roboto,Arial,sans-serif;color:#15233B;line-height:1.6;font-size:15px;">' +
    ...
    '<p><a href="' + esc(base) + '" style="display:inline-block;background:#0FB6A8;color:#fff;text-decoration:none;font-weight:700;padding:11px 20px;border-radius:8px;">Set up your account</a></p>' +
    '<ol><li>Choose <b>Get started</b> and sign up with this email: <b>' + esc(to) + '</b></li>' +
    '<li>Create your own password (only you will know it).</li></ol>' +
    '<p>Already have an account? Just sign in. Forgot your password? Use the <b>Forgot password?</b> link on the sign-in box to reset it.</p>' +
...
module.exports = { sendNewCustomerEmails, sendFeedbackEmail, sendTeamInviteEmail, sendTeamAddedAdminEmail, sendAccessRequestEmail };
