...
async function refreshProducts(account, actor, p, campaign) {
  ...
  await db.updateProspect(account, actor, p.id, { skus: shop.skus, suggested_product_url: pick.url, suggested_product_name: pick.name, product_photo_check: pick.check, why_this_product: pick.why });
