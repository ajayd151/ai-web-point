...
function nextProduct(p) { const c = Array.isArray(p.product_candidates) ? p.product_candidates : []; return c[1] && c[1].name && c[1].name !== p.suggested_product_name ? c[1].name : ''; }
...
module.exports = { DEFAULT_PROFILE, DEFAULT_TEMPLATES, render, templatesWith, URL_PLACEHOLDER, firstName, cleanObservation, genericObservation, proofLine, nextProduct, connectionNote, messageA, messageB, followUp1, followUp2, postCheck, generate };
