...
async function recordApplication(a) {
  ...
  try {
    ...
    await sql`INSERT INTO applications (name, email, business, website, role, volume, channels, why)
      VALUES (${a.name}, ${a.email}, ${a.business || null}, ${a.website || null},
...
module.exports = { recordEvent, statsBySlug, dbConfigured, recordApplication };
