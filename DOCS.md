...
- **Still pending:** in-app **Super Admin** (see all customers + usage), per-tier **feature gating + credits**, and UX polish (full-page sign-up instead of the Clerk popup, more top-nav items, mandatory first/last name).
